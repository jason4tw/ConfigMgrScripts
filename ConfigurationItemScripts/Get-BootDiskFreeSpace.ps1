<#
.SYNOPSIS
    Gets the free disk space from the boot volume in GB and rounded down.

.DESCRIPTION
    Gets the free disk space from the boot volume in GB and rounded down.

.EXAMPLE
    .\Get-BootDiskFreeSpace.ps1
...
$freeSpace = (Get-CIMInstance -Namespace root\cimv2 -Class Win32_LogicalDisk `
    -Filter "DeviceID='$env:SystemDrive'").FreeSpace

return ([math]::Floor($freeSpace / 1GB))


# SIG # Begin signature block
# MIIexQYJKoZIhvcNAQcCoIIetjCCHrICAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCATIQ0muPuk/xKk
# 54LlWMw8MfQ1IjJWoMWbvB4sJXlLQKCCGawwggSEMIIDbKADAgECAhBCGvKUCYQZ
...
# hvcNAQkEMSIEILXKYLyCy23HrqZD0cTmcgXaSfWLpC1Ha8+Kxu2bqAfvMA0GCSqG
# SIb3DQEBAQUABIIBAB7g7bIzE7evK8VgZCZOOiJXBZDzsdIRGJbYG/hpqz9d0sYC
# 38yNQrBueTtt6KSL2UK4NEWaVgiDnOLfwUY/gJ4j9GIi8e2x5ZN0tv9YABC2XUnD
# oXUoDZLnmjPifW2UNE/4nW6+8fFDqtN5/SLlthRf5DOSwI3H8v7Ahwub6M/2G8Jm
# YJBpUOFIBTJUa9/a7IPplXyNzl+XtrsE72bJAK2AiieveXWzwXV308ME74ytofF3
# xhtXsABLTFIasonj9nul8b8IX4Vs8t9Ec5LY0amfQv4hPtMxdN7ekUzAHjAJ5mVj
# LCMhqyTbwuOJPG+2SPODigRSGa4z+/kqUhxlKjShggIoMIICJAYJKoZIhvcNAQkG
...
# AQcBMBwGCSqGSIb3DQEJBTEPFw0xOTEyMDIwMjQwMDBaMCMGCSqGSIb3DQEJBDEW
# BBSINAw4tRdurwGOwowhARYx4vS/mDANBgkqhkiG9w0BAQEFAASCAQCssJOnRiU9
# FGW1q9emCbKHtnxVTyuepiUCVs/5qKIn0p22bOfFft7TrgHF4F/sL7dc1XXc8H93
# z10q4iG8cCoqjBlNMJYhhH1fVoZB/mZgK+ieJSNmUvr1V62qokfAETKl+rWPm9vX
# AA20KhbwDkxJQ1SJfpZprhVvCnBwdFJsemeDNTTzWEZadJQOKkV5UUb/6x7iW5rv
# CVW3s+3OO5gkDFcCl26e1M4yGh7Gk8NcQT1pQU7mr4QTAUYYMOIayDcRvFfUItik
# w8oDAQDfUUva13VOkyxLOphock+n7BF+GKKqQc1V3Pt9o5Z4ef39yGDoM0mRXw/F
# qY0I3sUwHgFO
