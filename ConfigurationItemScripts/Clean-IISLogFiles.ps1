<#
.SYNOPSIS
    Cleans IIS log files older than a specified age.
    
.DESCRIPTION
    Cleans IIS log files older than a specified age.

.PARAMETER MaxAge
    The maximum log file age; log files older than this age (in days) will be deleted.
    
.EXAMPLE
    .\Clean-IISLogFiles.ps1
        
.NOTES
    Author: Jason Sandys
    Version: 1.0
    Change history:
        12.24.2019 - first release
...
param
(
    [Parameter(HelpMessage="The maximum log file age; log files older than this age (in days) will be deleted.")]
    [int] $MaxAge = 30
)
...
try
{
    ...
    foreach($logLocation in ((Get-Website).LogFile.directory))
    {
        ...
        if(-not ($locations.Contains($log)))
        {
            ...
            Get-ChildItem -Path $log -Recurse -Filter "*.log" | Where-Object { $(Get-Date).Subtract($_.LastWriteTime).Days -gt $maxAge} | Remove-Item -Force
        }
    }
}
catch
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAPwz8MPIScgjXf
# QWg/F1SZ3TJdX+Sx0qzd3bW9hrwtp6CCGawwggSEMIIDbKADAgECAhBCGvKUCYQZ
...
# hvcNAQkEMSIEIHnuImKAeaD15bC/KG52QMsSjHrDVwc85hSv0ckikOAMMA0GCSqG
# SIb3DQEBAQUABIIBAFK/7bfNPc0RgspA6qoksMWmvk2K3nMqcSzHl2+UZ+tRW47e
# mb8Mdq/4EnHkaY+G2Kr28vzAJi9GU02Qc0he8YxCIlELhD26nJXzH42fuRFF6Fdb
# n80gXwoMlitLWcI0p66Khtbs1V34xEWd/sVc+CxfVQuhqX8lefD68Pl8ulCNaYt8
# UsJhsYKpx94JztTpvMeJloCiYhfjdWuTw9iCSqo4hnIZvvNtxq0S/xUahB/0Fv3u
# sO2ac1giuvix5TSf99N3KEeqfPFKidoIAzw4OF88jYMTjFOBaLsOv2KfWkmbq9+u
# vyLzV7sbQD9L3RWjpx+W4SzUz4ppL0EsQQxT0XuhggIoMIICJAYJKoZIhvcNAQkG
...
# AQcBMBwGCSqGSIb3DQEJBTEPFw0xOTEyMjQxOTIyMjhaMCMGCSqGSIb3DQEJBDEW
# BBRAYWrSJM8LPdEus8oFQ++K/RSpFTANBgkqhkiG9w0BAQEFAASCAQCFmJ3+ItfD
# MUKQbRNlniaJqtl7AYXku/LFncNwr/brWZkc6jaIXEEKaRUKFvtzpfI+7O3UU1us
# oKHQxOlGt1Eu9f2IX96n6V7OWbfsDR/i82SGZXROXYk5lripUYaXw1AJCg3q/toa
# NtYFzH2UFTNhPrRD/hvnr+jQQassMZIaPr3cDEMU+IVbu/N5ZQr/RE/3VR8ZFdhx
# HoBzl3d7Jr22m3D5ttofrEkAf8LQJ+jAmB8vM9kt2vTYXxl1Uy7z/8PBsnnw9E0o
# LThPBLiEzr3u0P3GTQI6Ku0blv5yX1tf0Vc0U+e5LRKbJhSpqliMaOQStLsEC09t
# MNJEfh3j6tan
