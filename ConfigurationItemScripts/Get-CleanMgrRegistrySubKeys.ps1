$keys = Get-ChildItem -Path "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\VolumeCaches"
...
foreach ($k in $keys)
{
    ...
    {
        if($prop -eq 'StateFlags0007')
        {
            $keylist += $k.PSChildName
        }
    }
}

($keylist | ForEach-Object { """$_""" }) -join ","

# SIG # Begin signature block
# MIIexQYJKoZIhvcNAQcCoIIetjCCHrICAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAwkg8t2QP2tAy2
# ENagmHw8iQTnW68YLpA0hiKORIYcxqCCGawwggSEMIIDbKADAgECAhBCGvKUCYQZ
...
# hvcNAQkEMSIEIDM077nahISeI5efxkhkiwwZCLE3hAO05o6qYhNTfULCMA0GCSqG
# SIb3DQEBAQUABIIBAGsGVdJEChlp4uM8wV4D1/IAlHDaVfYIi+puxYMEHMhfyAYV
# zd2wpfJaY/K7rc/y7t12m9eBbcAPmmLRBtsHi9kwV99GFWV7sRhhkpM0OIyS4/wq
# 7uilly90mDaf3qZUuKfo4P7D16T7MWJoWsZOjWXFYO6HKokNXSc7Xx9okh0f8J3g
# 3kG3Kya4WiXx2NUgEkkjFbCzTNV6AzzyizvdXmwdDlmeRWk8vqnB7CINEoPw7C1g
# l7Gt4a3XjerXOz0CcoqdCM/zDjXuuB0xpnLfI5TX+oTThX9a1NNt60qkqAroI8vE
# r16/5BNXbSj6/CDpk6TANWcVzivJ9o4Kik5/gt2hggIoMIICJAYJKoZIhvcNAQkG
...
# AQcBMBwGCSqGSIb3DQEJBTEPFw0xOTEyMDMwMDEwNTBaMCMGCSqGSIb3DQEJBDEW
# BBTGp7hxBu6sWTfb00NiPQvdf0vKZjANBgkqhkiG9w0BAQEFAASCAQBTkBsOz/oz
# nNZbBBcYIGUHIHscQ21jOSBSrd24b1lTKRkn4WUKaxTKTnsF+LqbIANJ7sN68MP/
# t10XxF7JJm1D5EbYcFD3C+W2QMNzdYO21VJtSJFepvHrmfCnShwAdykGbRK+mEto
# sYPx1CtK9coR9nGp7nqW8d5+Wd8VB1xCwvkChzCHtDB4BeBf3DIhfO9teXCiPJXi
# ZBfmrLQmpuCwaTby0Wv4L6NLkirRONbYvC4uTtFmjNQ67l2ITa86gl2rsIxsoMOb
# JdqZ4px53i0HUEVLCY3H4dAOEt/bLxCZdOy+rsjstECyQoszKZQOraXR0eE/zh1s
# pLciQo0a5j1v
