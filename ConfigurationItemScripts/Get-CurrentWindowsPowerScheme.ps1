<#
.SYNOPSIS
    Gets the currently configured Windows Power Scheme from powercfg.
    
.DESCRIPTION
    Gets the currently configured Windows Power Scheme from powercfg.
    
.EXAMPLE
    .\Get-CurrentWindowsPowerScheme.ps1
...
foreach($scheme in $pwr)
{
    if($scheme -match '\((?<scheme>[\w ]*)\) \*')
    {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCBBDTJV334cTCM
# +zbW4MRlxZ8vDqyDHnoQsnyx9zc0bKCCGawwggSEMIIDbKADAgECAhBCGvKUCYQZ
...
# hvcNAQkEMSIEIFE4vIMA2X/TrzdpYJMgOGiQgwUfx3zaU7XUU/GNYzYhMA0GCSqG
# SIb3DQEBAQUABIIBAO38QRk1Ge0Qp5nRkIw11kzpp3kIqJVgDajCNZckMMrjwcds
# Y9Tn/5l2KLbHxM9p0XVrIUuVb6oXZDpuDbQOaIQ6MdrY5QCX1j+50Rbf11FUW7a5
# Ar6JgjB2fDqc0KKnbZrCOvdCjih/Gy+tPLZGZGDFwdKmMyrl8K+C4UFQEraQW1JU
# U1BgicxcsG3EsBEW5zi/DE/Ek5d7sEzDh4nYVdfnHK0QPWUTQFQ8ZOh9+CG28FlP
# QMhXGBi1BbR21G1PKxulCmJotWv9pGJv3Ck9v+NuGgkZcRAVpEYzm2rMx8MqSuAy
# 895r8tCVWevW5PhR2kiTrraFuaPjNOqjP5jHg4ahggIoMIICJAYJKoZIhvcNAQkG
...
# AQcBMBwGCSqGSIb3DQEJBTEPFw0xOTEyMDMwMDU5NTRaMCMGCSqGSIb3DQEJBDEW
# BBTVYvat5pACBN9AsoQkVizRednyzzANBgkqhkiG9w0BAQEFAASCAQALDYmBiHxE
# 4icQbKc+T6OdJAIyRr7y/mTJVUuHLMf/TZQGhbjilFy8E1Ao0PiPuWbVebQVWyUR
# 1H/40FjCdTF6LpjGE8NZNFEC2qZmc5PgLPUOMp9CbF7FstwloPDUEfJz0mYHUZ24
# quZ7/cvMwi7xLsEPwNeT/biBpRFi6d7YreEq8NYBNHAzHHqGVpG4G2Gec76655PN
# mni7+VJhtZoDyyH7zPTaODoxEG01AZOaF8tr5VIuj8q5asXkhtgwdMZkiGzfkFpX
# XCs2gT8L1lzHtaYZbplMQggxRV80ufNL1WJ0ZSy0dzBDBdIsVLA4EopHBsnjaKlV
# tjAu+1V+xL7U
